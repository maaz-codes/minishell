...
SRCS = minishell.c signals.c tokenization.c builtins/echo_cmd.c builtins/pwd_cmd.c builtins/cd_cmd.c builtins/exit_cmd.c \
		builtins/env_cmd.c builtins/cd_utils.c builtins/unset_cmd.c builtins/export_cmd.c builtins/exit_utils.c \
		builtins/export_utils.c token_utils.c libft/ft_atol.c libft/ft_split.c libft/ft_memset.c\
